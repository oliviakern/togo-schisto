...
Here I apply a set of ordinary differential equations adapted from Soklow et al. 2017 to which I have added (\iota,y,z) to reflect local dynamics observed during fieldwork contributing to Schistosomiasis transmission in Ogou. I also developed an equation to describe the likelihood of mass drug administration (MDA) success as a function of the variables $f$, $a$, $p$, $$ affecting treatment compliance.
